...
This paper demonstrates use of R packages \textbf{ggmap}\footnote{Kahle, D. and Wickham, H., \textbf{ggmap: Spatial Visualization with ggplot2}, \textit{The R Journal}, Vol. 5/1, \url{http://journal.r-project.org/archive/2013-1/kahle-wickham.pdf}} and related packages for 
