...
Using hurricane forecast geospatial data from the National Hurrican Center, this use case determines properties within forecasted path of the storm.  For this example, the October 28, 2012 forecast 
...
values for the properties are uniform psuedo-random values between \$50,000 and \$200,000.  The
